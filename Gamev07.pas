...
//    setpenwidth (3);
    ...
    for i:=1 to eN do
    begin
      if enemys[i,1]<px then if  enemys[i,2]<py then  begin//x1,y1
      ...
      if enemys[i,1]<px then if  enemys[i,2]>py then  begin//x1,y2
                                                         if random(1)=0 then if map[enemys[i,1],enemys[i,2]-1]=1 then begin
                                                                                                                        wayG(enemys[i,1]*20,enemys[i,2]*20);
                                                                                                                        map[enemys[i,1],enemys[i,2]]:=1;
                                                                                                                        enemys[i,2]-=1;
      ...
      if enemys[i,1]>px then if  enemys[i,2]<py then  begin//x2,y1
                                                         if random(1)=0 then if map[enemys[i,1],enemys[i,2]+1]=1 then begin
                                                                                                                        wayG(enemys[i,1]*20,enemys[i,2]*20);
                                                                                                                        map[enemys[i,1],enemys[i,2]]:=1;
                                                                                                                        enemys[i,2]+=1;
      ...
      if enemys[i,1]>px then if  enemys[i,2]>py then  begin//x2,y2
                                                         if random(1)=0 then if map[enemys[i,1],enemys[i,2]-1]=1 then begin
                                                                                                                        wayG(enemys[i,1]*20,enemys[i,2]*20);
                                                                                                                        map[enemys[i,1],enemys[i,2]]:=1;
                                                                                                                        enemys[i,2]-=1;
