...
begin
  ...
  begin
    ...
    begin
    if (map[enemys[i,1]+1,enemys[i,2]]=1) or (map[enemys[i,1]+1,enemys[i,2]]=3)or (map[enemys[i,1]+1,enemys[i,2]]=4) then
    begin
    ...
    begin
     ...
     begin
     if (map[enemys[i,1],enemys[i,2]+1]=1) or (map[enemys[i,1],enemys[i,2]+1]=3) or (map[enemys[i,1],enemys[i,2]+1]=4) then
    begin
    ...
    i2:=path.Min;
    if path[4]=i2 then i3:=4;
    if path[2]=i2 then i3:=2;    
    if path[3]=i2 then i3:=3;    
    if path[1]=i2 then i3:=1;
...
begin                                                    //начало кода
  ...
  writeln('If you want to press Enter after every turn, press 1');
  writeln('If you don',<>,'t want to press Enter after every turn, press 0');
  for i:=1 to 10 do writeln;
  more2:
  read(plcontrol);
  case plcontrol of
